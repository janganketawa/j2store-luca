...
class J2StoreControllerShippingMethods extends JController {
    ...
    function save() {
		...
		$link = 'index.php?option=com_j2store&view=shippingmethods';
    ...
    function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_j2store&view=shippingmethods', 'Deleted item(s)' );
	}
	...
	function publish()
	{
		...
		$this->setRedirect( 'index.php?option=com_j2store&view=shippingmethods' );
	}
	...
	function setrates(){
        ...
        $view->set( '_action', "index.php?option=com_j2store&view=shippingmethods&task=setrates&id=".$id."&tmpl=component" );
    ...
    function saverates()
    {
        ...
        $redirect = "index.php?option=com_j2store&view=shippingmethods&task=setrates&id={".$id."}&tmpl=component";
    ...
    function createrate()
    {
		...
		$redirect = "index.php?option=com_j2store&view=shippingmethods&task=setrates&id={$row->shipping_method_id}&tmpl=component";
        $redirect = JRoute::_( $redirect, false );
    ...
    function deleterates(){
		...
		if (!isset($this->redirect)) {
			...
			: 'index.php?option=com_j2store&view=shippingmethods&task=setrates&id='.$ship_method_id.'&tmpl=component';
