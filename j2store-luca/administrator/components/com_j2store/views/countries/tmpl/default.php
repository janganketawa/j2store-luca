		...
		<!-- search filter -->
		  ...
		  <table id="adminTable" class="adminlist" width="100%" cellpadding="2" cellspacing="2" >
			...
			<thead>
				...
				<th class="name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_COUNTRY_NAME', 'a.country_name', $listDirn, $listOrder); ?>
				</th>
				<th class="code2">
					<?php echo JHtml::_('grid.sort',  'J2STORE_COUNTRY_CODE2', 'a.country_isocode_2', $listDirn, $listOrder); ?>
				</th>
				<th class="code3">
					<?php echo JHtml::_('grid.sort',  'J2STORE_COUNTRY_CODE3', 'a.country_isocode_3', $listDirn, $listOrder); ?>
				</th>
				<th width="5%">
					<?php echo JHtml::_('grid.sort',  'JPUBLISHED', 'a.state', $listDirn, $listOrder); ?>
				</th>
				<th class="id">
					<?php echo JHtml::_('grid.sort',  'J2STORE_COUNTRY_ID', 'a.country_id', $listDirn, $listOrder); ?>
				</th>
