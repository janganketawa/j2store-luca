...
JHTML::_('stylesheet', 'style.css', 'components/com_j2store/css/');
$row = @$this->row;
$order = @$this->order;
...
<div class='componentheading'>
	<span><?php echo JText::_( "J2STORE_ORDER_DETAIL" ); ?></span>
</div>
	...
	<table class="cart_order" style="clear: both;">
		...
		<tbody>
			...
			<tr class='row<?php echo $k; ?>'>
				<td>
						<?php echo JText::_( $item->orderitem_name ); ?> <br /> <?php if (!empty($item->orderitem_attribute_names)) : ?>
