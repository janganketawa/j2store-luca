...
<div class='componentheading'>
    ...
    <?php
    echo "<< <a href='".JRoute::_("index.php?option=com_j2store&view=orders")."'>".JText::_( 'J2STORE_ORDER_RETURN_TO_LIST' )."</a>";
    ?>
	...
	<table class="orders" >
		<tr id="order_info">
			<td> 		<h3><?php echo JText::_("J2STORE_ORDER_INFORMATION"); ?></h3> </td>
			<td>
				<div>
				<table class="orderInfoTable" >
					...
					<tr>
						<td> <strong><?php echo JText::_("J2STORE_ORDER_ORDER_ID"); ?></strong> </td>
						<td> <?php echo @$row->order_id; ?> </td>
					</tr>
					<tr>
						<td> <strong><?php echo JText::_("J2STORE_INVOICE_NO"); ?></strong> </td>
						<td> <?php echo @$row->id; ?> </td>
					</tr>
					<tr>
						<td> <strong><?php echo JText::_("J2STORE_ORDER_DATE"); ?></strong> </td>
						<td> <?php echo JHTML::_('date', $row->created_date, $this->params->get('date_format', '%a, %d %b %Y, %I:%M%p')); ?> </td>
					</tr>
					<tr>
						<td> <strong><?php echo JText::_("J2STORE_ORDER_STATUS"); ?></strong> </td>
						<td>
						<form action="<?php echo $order_state_save_link; ?>" method="post" name="adminForm" >
						<?php echo @$this->order_state; ?>
						<input type="hidden" name="id" value="<?php echo $row->id; ?>"  />
						<input type="submit" value="<?php echo JText::_('J2STORE_ORDER_STATUS_SAVE'); ?>"  />
						</form>
						</td>
					</tr>
		...
		<tr id="payment_info"  style="background-color: #CEE0E8;">
			<td> <h3><?php echo JText::_("J2STORE_ORDER_PAYMENT_INFORMATION"); ?></h3>  </td>
			<td>
				<div>
				<table class="paymentTable" >
					<tr  ><td></td>
					...
					<tr>
						<td> <strong><?php echo JText::_("J2STORE_ORDER_AMOUNT"); ?></strong> </td>
						<td> <?php echo J2StorePrices::number( $row->order_total ); ?> </td>
					</tr>
						...
						<tr>
							...
							if(empty($row->shipping_first_name)) {
								...
								echo $row->shipping_country_name." <br/> ".JText::_('J2STORE_TELEPHONE').":";
		...
		<tr>
			<td> <strong><?php echo JText::_("J2STORE_ORDER_ASSOCIATED_PAYMENT_RECORDS"); ?></strong><br/></td>
			<td>
			   <div>
		       <table class="paymentTable">
	...
	<table class="cart_order" style="clear: both;">
		...
		<tbody>
			...
			<tr class='row<?php echo $k; ?>'>
				<td><a target="_blank"
					href="<?php echo JURI::root().'index.php?option=com_content&view=article&id='.$item->product_id; ?>">
