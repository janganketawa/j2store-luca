...
<fieldset>
	<legend><?php echo JText::_('J2STORE_SHIPM_SHIPPING_DETAILS'); ?> </legend>
	...
	<table class="admintable" width="100%">
		...
		<tr>
			<td width="100" align="right" class="key">
				<label for="shipping_method_name">
					<?php echo JText::_( 'J2STORE_SHIPM_SHIPPING_METHOD' ); ?>:
				</label>
			</td>
			<td>
		...
		<tr>
			<td width="100" align="right" class="key">
				<label for="shipping_method_type">
					<?php echo JText::_( 'J2STORE_SHIPM_SHIPPING_TYPE' ); ?>:
				</label>
			</td>
			<td>
				<select id="shipping_method_type" name="shipping_method_type">
					<option selected="selected" value="0"><?php echo JText::_('J2STORE_SHIPM_FLAT_RATE_PER_ORDER');?></option>
					<option value="1"><?php echo JText::_('J2STORE_SHIPM_QUANTITY_BASED_PER_ORDER');?></option>
					<option value="2"><?php echo JText::_('J2STORE_SHIPM_PRICE_BASED_PER_ORDER');?></option>
				</select>
			</td>
		</tr>
		...
		<tr>
			<td valign="top" align="right" class="key">
				<?php echo JText::_( 'J2STORE_SHIPM_STATE' ); ?>:
			</td>
			<td>
